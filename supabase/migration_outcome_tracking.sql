...
ALTER TABLE signals_history ADD COLUMN IF NOT EXISTS target_1_price NUMERIC(10,2) DEFAULT NULL;
ALTER TABLE signals_history ADD COLUMN IF NOT EXISTS target_2_price NUMERIC(10,2) DEFAULT NULL;
ALTER TABLE signals_history ADD COLUMN IF NOT EXISTS target_3_price NUMERIC(10,2) DEFAULT NULL;
