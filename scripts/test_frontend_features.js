/**
 * Test Frontend Features Math & Logic
 * ====================================
 * Tests:
 * 1. Scenario A: PLTR (Scale 60/30/10, Allocated $500)
 *    T1 exit: $300.00
 *    T2 exit: $150.00
 *    T3 exit: $50.00
 *    Remaining after T1: $200.00
 * 2. Scenario B: AAPL Pullback Recovery (Scale 70/30/0, Allocated $500, T2/T3 null)
 *    T1 exit: $350.00
 *    T2: — (removed)
 *    T3: — (removed)
 *    Runner remaining after T1: $150.00
 * 3. State machine transitions simulation for /api/signals/recalculate
 */

const { parseScaleOut, getDollarExits, getSharesForScaleOut } = require('../frontend/src/lib/position-utils.ts');
